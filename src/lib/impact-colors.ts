...
export const IMPACT_RATING_BADGE_SOFT: Record<ImpactRating, string> = {
  high: 'bg-red-500/10 text-red-500 border-red-500/20 dark:bg-red-900/30 dark:text-red-400', // palette-ok: distinct CIA impact-rating accent (peer to severity-colors.ts)
  moderate:
    'bg-yellow-500/10 text-yellow-500 border-yellow-500/20 dark:bg-yellow-900/30 dark:text-yellow-400', // palette-ok: distinct CIA impact-rating accent
  low: 'bg-green-500/10 text-green-500 border-green-500/20 dark:bg-green-900/30 dark:text-green-400', // palette-ok: distinct CIA impact-rating accent
}
