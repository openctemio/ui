...
export const assetRelationships: AssetRelationship[] = [
  ...
  // ============================================
  {
    ...
    description: 'Oracle database runs on AWS production VPC',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 10,
  ...
  },
  {
    ...
    targetAssetType: 'cloud_account',
    description: 'PostgreSQL database runs on GCP production project',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 10,
  ...
  // ============================================
  // Database → Database (sends_data_to - replication)
  // ============================================
  {
    id: 'rel-034',
    type: 'sends_data_to',
    sourceAssetId: 'db-003',
    sourceAssetName: 'MongoDB - analytics.db.vn',
    sourceAssetType: 'database',
    targetAssetId: 'db-005',
    targetAssetName: 'Elasticsearch - logs.elastic.vn',
    targetAssetType: 'database',
    description: 'MongoDB replicates analytics data to Elasticsearch for search',
    confidence: 'medium',
    discoveryMethod: 'manual',
    impactWeight: 6,
    tags: ['replication', 'search'],
  ...
  // ============================================
  {
    ...
    targetAssetName: 'Kafka - events.internal.vn:9092',
    targetAssetType: 'service',
    description: 'Redis sends cache invalidation events to Kafka',
    confidence: 'medium',
    discoveryMethod: 'automatic',
    impactWeight: 7,
    tags: ['event-driven'],
  ...
  // ============================================
  {
    ...
    sourceAssetName: 'techcombank.com.vn',
    sourceAssetType: 'domain',
    targetAssetId: 'ip-001',
    targetAssetName: '103.28.36.10',
    targetAssetType: 'ip_address',
    description: 'Banking domain resolves to CDN IP',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 8,
    tags: ['dns', 'attack-surface'],
    createdAt: daysAgo(365),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  {
    ...
    sourceAssetName: 'fpt.com.vn',
    sourceAssetType: 'domain',
    targetAssetId: 'ip-002',
    targetAssetName: '210.245.0.1',
    targetAssetType: 'ip_address',
    description: 'FPT domain resolves to primary IP',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 7,
    tags: ['dns', 'attack-surface'],
  ...
  // ============================================
  // API → Database (stores_data_in) - NEW
  // ============================================
  {
    id: 'rel-043',
    type: 'stores_data_in',
    ...
    targetAssetName: 'Oracle - core-banking.db.vn',
    targetAssetType: 'database',
    description: 'Core Banking API stores transaction data in Oracle',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 10,
    tags: ['data-at-rest', 'critical'],
    createdAt: daysAgo(400),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  {
    ...
    targetAssetName: 'MongoDB - analytics.db.vn',
    targetAssetType: 'database',
    description: 'Customer Data API stores analytics data in MongoDB',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 8,
    tags: ['data-at-rest', 'pii'],
    createdAt: daysAgo(200),
    updatedAt: daysAgo(1),
    lastVerified: daysAgo(0),
  },
  ...
  // ============================================
  {
    ...
    sourceAssetName: 'ebanking.techcombank.com.vn',
    sourceAssetType: 'website',
    targetAssetId: 'svc-waf-001',
    targetAssetName: 'Cloudflare WAF',
    targetAssetType: 'service',
    description: 'Internet banking protected by Cloudflare WAF',
    confidence: 'high',
    discoveryMethod: 'manual',
    impactWeight: 10,
    tags: ['waf', 'security-control'],
    createdAt: daysAgo(300),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  {
    id: 'rel-046',
    type: 'protected_by',
    sourceAssetId: 'host-001',
    sourceAssetName: 'db-server-01.internal.vn',
    sourceAssetType: 'host',
    targetAssetId: 'svc-edr-001',
    targetAssetName: 'CrowdStrike Falcon',
    targetAssetType: 'service',
    description: 'Database server protected by CrowdStrike EDR',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 9,
    tags: ['edr', 'security-control'],
    createdAt: daysAgo(250),
    updatedAt: daysAgo(1),
    lastVerified: daysAgo(0),
  },
  ...
  // ============================================
  // SIEM → Assets (monitors) - NEW
  // ============================================
  {
    id: 'rel-047',
    type: 'monitors',
    sourceAssetId: 'svc-siem-001',
    sourceAssetName: 'Splunk SIEM',
    sourceAssetType: 'service',
    targetAssetId: 'cluster-001',
    targetAssetName: 'prod-gke-cluster',
    targetAssetType: 'k8s_cluster',
    description: 'Splunk SIEM monitors production Kubernetes cluster',
    confidence: 'high',
    discoveryMethod: 'manual',
    impactWeight: 8,
    tags: ['siem', 'observability'],
    createdAt: daysAgo(200),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  {
    ...
    targetAssetName: 'aws-prod-vpc-01',
    targetAssetType: 'cloud_account',
    description: 'Splunk SIEM monitors AWS production VPC',
    confidence: 'high',
    discoveryMethod: 'manual',
    impactWeight: 8,
    tags: ['siem', 'observability', 'aws'],
    createdAt: daysAgo(200),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  ...
  // ============================================
  {
    id: 'rel-049',
    type: 'granted_to',
    sourceAssetId: 'cred-001',
    sourceAssetName: 'admin-service-account',
    sourceAssetType: 'credential',
    targetAssetId: 'cloud-002',
    targetAssetName: 'gcp-prod-project',
    targetAssetType: 'cloud_account',
    description: 'Admin service account has owner role on GCP project',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 10,
    tags: ['iam', 'privilege', 'critical'],
    createdAt: daysAgo(350),
    updatedAt: daysAgo(0),
    lastVerified: daysAgo(0),
  },
  {
    id: 'rel-050',
    type: 'granted_to',
    sourceAssetId: 'cred-002',
    sourceAssetName: 'ci-cd-service-account',
    sourceAssetType: 'credential',
    targetAssetId: 'cluster-001',
    targetAssetName: 'prod-gke-cluster',
    targetAssetType: 'k8s_cluster',
    description: 'CI/CD service account has deploy access to production cluster',
    confidence: 'high',
    discoveryMethod: 'automatic',
    impactWeight: 9,
    tags: ['iam', 'ci-cd', 'attack-path'],
    createdAt: daysAgo(250),
    updatedAt: daysAgo(1),
    lastVerified: daysAgo(0),
  },
