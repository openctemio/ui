 ...
 *
 * Area chart showing weekly clicks and unique visitors
 ...
 * 1. Create API endpoint in src/lib/api/endpoints.ts
 * 2. Use useAnalytics() hook from src/lib/api/hooks.ts
 * 3. Replace this mock data with: const { data } = useAnalytics()
 *
 * @see docs/API_INTEGRATION.md for examples
 */
const data = [
  {
    name: 'Mon',
