 ...
 */
export type SCMPermission = 'repo:read' | 'repo:write' | 'webhook:manage' | 'org:read' | 'user:read'
...
export const SCM_CONNECTION_STATUS_COLORS: Record<
  SCMConnectionStatus,
...
export const BRANCH_STATUS_COLORS: Record<
  BranchStatus,
