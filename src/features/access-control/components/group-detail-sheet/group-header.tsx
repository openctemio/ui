...
import { ShieldCheck, Users, Pencil, X, Save, Loader2 } from 'lucide-react'
import { type Group, getGroupType, GroupTypeConfig } from '@/features/access-control'
  ...
  return (
    <div className="relative px-6 pt-8 pb-6 bg-gradient-to-b from-muted/50 to-background">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <Badge className={`mt-3 ${typeConfig?.bgColor} ${typeConfig?.color} border-0`}>
          {typeConfig?.label}
        </Badge>
      </div>
    </div>
