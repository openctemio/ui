    ...
    permissions: [
      {
        key: 'scans:read',
        label: 'View Scans',
        description: 'View scan configurations and results',
      },
    ...
    permissions: [
      {
        key: 'pentest:read',
        label: 'View Pentest',
        description: 'View pentest campaigns and findings',
      },
      {
        key: 'pentest:write',
        label: 'Manage Pentest',
        description: 'Create campaigns and update findings',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'remediation:write',
        label: 'Manage Remediation',
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'members:invite', label: 'Invite Members', description: 'Invite new team members' },
      {
        ...
        description: 'Update member roles and remove members',
      },
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: 'Assign permission sets to groups',
      },
      {
        key: 'permission-sets:read',
        label: 'View Permission Sets',
        description: 'View permission sets',
      },
      {
        key: 'permission-sets:write',
        label: 'Manage Permission Sets',
        description: 'Create and update permission sets',
      },
      {
        key: 'permission-sets:delete',
        label: 'Delete Permission Sets',
        description: 'Delete custom permission sets',
      },
    ],
  },
  {
...
export function getPermissionInfo(
  key: string
): { label: string; description: string; category: string } | null {
