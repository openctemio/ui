...
export const sidebarData: SidebarData = {
  ...
  navGroups: [
    ...
    // ========================================
    {
      title: 'Scoping',
      items: [
        // Nested into three "context" sub-sections so the ~10 flat entries read
        // as a few expandable items instead of a wall. Each leaf keeps its own
        // permission + module (the parent carries none, so it is shown whenever
        // any child is visible and hidden when they are all filtered out).
        {
          title: 'Asset Context',
          icon: Boxes,
          items: [
    ...
    // ========================================
    {
      ...
      items: [
        // Split into "how attackers reach it" (Attack Modeling) vs "how we rank
        // it" (Risk Ranking) so the phase reads as two expandable items.
        {
